...
diretorio = '/home/nautec/Documents/Claudio/trabalho/UWData'     #'C:\\Claudio\\Doc_PPGMC\\Trabalho\\UWData\\'
diretorio_img = '/home/nautec/Documents/Claudio/trabalho/UWData/Saida Pipe_deg/'
diretorio_data = '/home/nautec/Documents/Claudio/trabalho/UWData/Datasets/'
validation_data_dir = '//home/nautec/Documents/Claudio/trabalho/UWData/valid'
diretorio_modelo = '/home/nautec/Documents/Claudio/trabalho/UWData/Saidas_Mod11/'
nome_modelo = "DENSERcDB_Full.json"
curva_loss = "DENSERcDB_Full_Loss"
dir_pen = '/media/nautec/KINGSTON/'

"""The dataset is loaded as a single file, containing images of 256x256x3 and scaled to [0., 1.0] for
training and test.
"""
os.chdir(diretorio_data)
f = open('UWData256_2K2', 'rb')
data = pickle.load(f)
f.close()
data = np.float32(data)

f = open('UWTest256X', 'rb')   #antes era o UWData_T3
seleta = pickle.load(f)
f.close()
seleta = np.clip(seleta, 0.001, 1.0)
seleta = np.float32(seleta)
...
def topx(img):
    ...
    imgx_out = tf.math.multiply((vmed-vmdn), tf.math.multiply(gr, imgx_out))
    return imgx_out
# =============================================================================
...
def ic_idb2(img):
    ...
    b0 = tf.math.multiply(haze(img), exp)
    b1 = tf.math.multiply((1.0 - expb), Boo) 
...
esp_saida_rede_cDB = rede_cDB.predict(seleta)
...
def grava():
    diretorio_MOD_files = '/home/nautec/Documents/Claudio/trabalho/UWData/Saidas_Mod11C/' 
    os.chdir(diretorio_MOD_files)
    nome = 'DHZ_SAT_20220721' #DHZ_Fundo_20220426_01
    f = open(nome, 'wb')
    pickle.dump(esp_saida_rede_cDB, f)
    f.close()
    nome = 'DHZ_SAT_202200721_DB' 
    f = open(nome, 'wb')
    pickle.dump(saida_DB, f)
    f.close()
    #os.chdir(diretorio)
    rede_cDB.save('/home/nautec/Documents/Claudio/trabalho/UWData/Saidas_Mod11C/Modelo11C_DHZ_SAT_06')
    DB.save('/home/nautec/Documents/Claudio/trabalho/UWData/Saidas_Mod11C/Modelo11C_DHZ_SAT_DB_06')
    return
